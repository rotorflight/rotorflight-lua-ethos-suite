...
local boxes = {
    ...
    {col = 1, row = 3, type = "time", subtype = "count", title = i18n("widgets.dashboard.flights"), titlepos = "top", bgcolor = colorMode.bgcolor, titlecolor = colorMode.titlecolor, textcolor = "green", transform = "floor"},
