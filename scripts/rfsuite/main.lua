...
rfsuite.app = assert(loadfile("app/app.lua"))(config, compile)
rfsuite.utils = assert(loadfile("lib/utils.lua"))(config, compile)



-- tasks
rfsuite.tasks = {}
rfsuite.bg = assert(loadfile("tasks/bg.lua"))(config, compile)

-- widgets
rfsuite.rf2gov = assert(loadfile("widgets/governor/governor.lua"))(config, compile)
rfsuite.rf2status = assert(loadfile("widgets/status/status.lua"))(config, compile)
