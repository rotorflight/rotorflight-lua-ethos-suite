...
local es = {
    ...
    FILTER_CONFIG = {
        ...
        rpm_min_hz = "Frecuencia Mínima para el filtro de RPM.",
        dyn_notch_q = "Factor de Calidad del Filtro de Puntos.",
        dyn_notch_max_hz = "Frecuencia Máxima a la que el Punto es aplicado.",
        dyn_notch_min_hz = "Frecuencia Mínima a la que el Punto es aplicado.",
        dyn_notch_count = "Número de Puntos a aplicar.",
        tbl_none = "NINGUNO",
        tbl_1st = "1RO",
        tbl_2nd = "2DO",
    },
