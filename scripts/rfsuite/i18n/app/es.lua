...
local es = {
       -- startup checks
        ...
        navigation_save            = "GUARDAR",
        navigation_reload          = "RECARGAR",
        navigation_tools           = "*",
        navigation_help            = "?",
        ...
        modules = {
            about = {
                ...
                supported_versions  = "Versiones MSP Soportadas",
            ...
            esc_motors = {
                name                    = "ESC/Motores",
                main_motor_ratio        = "Relación Motor Principal",
                tail_motor_ratio        = "Relación Motor de Cola",
                pinion                  = "Piñón",
                main                    = "Principal",
                rear                    = "Posterior",
                front                   = "Frente",
            ...
            status = {
                ...
                dataflash_free_space    = "Espacio libre en flash de datos",
