...
function frsky.setFblSensors(fblIds)
  ...
  -- (These mirror your legacy rename list, but only if sid.lua didn't provide sportRename)
  addFallbackRename(0x0500, "Headspeed",    "RPM")
  addFallbackRename(0x0501, "Tailspeed",    "RPM")
  addFallbackRename(0x0210, "Voltage",      "VFAS")
  addFallbackRename(0x0600, "Charge Level", "Fuel")
  addFallbackRename(0x0910, "Cell Voltage", "ADC4")
  addFallbackRename(0x0211, "ESC Voltage",  "VFAS")
  addFallbackRename(0x0B70, "ESC Temp",     "ESC temp")
  addFallbackRename(0x0218, "ESC1 Voltage", "VFAS")
  addFallbackRename(0x0208, "ESC1 Current", "Current")
  addFallbackRename(0x0508, "ESC1 RPM",     "RPM")
  addFallbackRename(0x0418, "ESC1 Temp",    "Temp2")
  addFallbackRename(0x0219, "BEC1 Voltage", "VFAS")
  addFallbackRename(0x0229, "BEC1 Current", "Current")
  addFallbackRename(0x0419, "BEC1 Temp",    "Temp2")
  addFallbackRename(0x021A, "ESC2 Voltage", "VFAS")
  addFallbackRename(0x020A, "ESC2 Current", "Current")
  addFallbackRename(0x050A, "ESC2 RPM",     "RPM")
  addFallbackRename(0x041A, "ESC2 Temp",    "Temp2")
  addFallbackRename(0x0840, "GPS Heading",  "GPS course")
  addFallbackRename(0x0900, "MCU Voltage",  "ADC3")
  addFallbackRename(0x0901, "BEC Voltage",  "ADC3")
  addFallbackRename(0x0902, "BUS Voltage",  "ADC3")
  addFallbackRename(0x0201, "ESC Current",  "Current")
  addFallbackRename(0x0222, "BEC Current",  "Current")
  addFallbackRename(0x0400, "MCU Temp",     "Temp1")
  addFallbackRename(0x0401, "ESC Temp",     "Temp1")
  addFallbackRename(0x0402, "BEC Temp",     "Temp1")
  addFallbackRename(0x5210, "Y.angle",      "Heading")
end
