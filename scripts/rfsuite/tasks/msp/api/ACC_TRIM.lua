...
local MSP_API_STRUCTURE_READ_DATA = {
    { field = "pitch", type = "U16", apiVersion = 12.06, simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°", help = rfsuite.i18n.get("api.ACC_TRIM.pitch")},
    { field = "roll",  type = "U16", apiVersion = 12.06, simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°", help = rfsuite.i18n.get("api.ACC_TRIM.roll")},
}
