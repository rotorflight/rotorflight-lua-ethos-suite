...
if rfsuite.utils.apiVersionCompare(">=", "12.09") then
    ...
    MSP_API_STRUCTURE_READ_DATA = {
        ...
        {field = "gov_throttle_hold_timeout",       type = "U16", apiVersion = 12.09, simResponse = {30, 0},  min = 0,  max = 250, unit = "s", default = 5,  decimals = 1, scale = 10},
        ...
        {field = "gov_idle_collective",             type = "S8",  apiVersion = 12.09, simResponse = {0}, unit = "%", min = -100, max = 100},
        {field = "gov_wot_collective",              type = "S8",  apiVersion = 12.09, simResponse = {0}, unit = "%", min = -100, max = 100}
    }
