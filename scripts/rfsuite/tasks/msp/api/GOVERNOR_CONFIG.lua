...
local MSP_API_STRUCTURE_READ = {{field = "gov_mode", type = "U8"}, {field = "gov_startup_time", type = "U16"}, {field = "gov_spoolup_time", type = "U16"}, {field = "gov_tracking_time", type = "U16"}, {field = "gov_recovery_time", type = "U16"}, {field = "gov_zero_throttle_timeout", type = "U16"}, {field = "gov_lost_headspeed_timeout", type = "U16"},
                                {field = "gov_autorotation_timeout", type = "U16"}, {field = "gov_autorotation_bailout_time", type = "U16"}, {field = "gov_autorotation_min_entry_time", type = "U16"}, {field = "gov_handover_throttle", type = "U8"}, {field = "gov_pwr_filter", type = "U8"}, {field = "gov_rpm_filter", type = "U8"}, {field = "gov_tta_filter", type = "U8"},
                                {field = "gov_ff_filter", type = "U8"}, {field = "gov_spoolup_min_throttle", type = "U8"}}
