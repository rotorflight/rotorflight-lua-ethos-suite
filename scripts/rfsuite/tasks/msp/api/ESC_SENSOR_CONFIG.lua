...
local escTypes = {"ESC1","ESC2", etc}
local onOff = {"OFF","ON"}
local MSP_API_STRUCTURE_READ_DATA = {
    {field = "protocol",                     type = "U8",  apiVersion = 12.06, simResponse = {0},     table = escTypes},
    {field = "half_duplex",                  type = "U8",  apiVersion = 12.06, simResponse = {0},     table = onOff},
    {field = "update_hz",                    type = "U16", apiVersion = 12.06, simResponse = {200, 0}, min = 10, max = 500, unit = "Hz"},
    {field = "current_offset",               type = "U16", apiVersion = 12.06, simResponse = {0, 15}, min = 0, max = 1000},
    {field = "hw4_current_offset",           type = "U16", apiVersion = 12.06, simResponse = {0, 0},  min = 0, max = 1000},
