...
local API_NAME = "FBL_CONFIG" -- API name (must be same as filename)
local MSP_API_CMD_READ = 16 -- Command identifier for MSP Mixer Config Read
...
local function write(suppliedPayload)
    return nil -- No write operation defined for this API
end
