...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "escinfo_17",              type = "U8",  apiVersion = 12.07, simResponse = {1}},
    ...
    {field = "bec_voltage",             type = "U8",  apiVersion = 12.07, simResponse = {1},           table = {"Disabled", "7.5V", "8.0V", "8.5V", "12.0V"}, tableIdxInc = -1},
