...
pages[#pages + 1] = {
    title = "Main Rotor",
    section = 1,
    script = "profile_mainrotor.lua",
    image = "mainrotor.png"
}
pages[#pages + 1] = {
    title = "Tail Rotor",
    section = 1,
    script = "profile_tailrotor.lua",
    image = "tailrotor.png"
}
pages[#pages + 1] = {
    title = "Governor",
...
pages[#pages + 1] = {
    ...
    section = 2,
    script = "profile_pidcontroller.lua",
    image = "pids-controller.png"
}
pages[#pages + 1] = {
    title = "PID Bandwidth",
    section = 2,
    script = "profile_pidbandwidth.lua",
    image = "pids-bandwidth.png"
}
pages[#pages + 1] = {
    title = "Auto Level",
    section = 2,
    script = "profile_autolevel.lua",
    image = "autolevel.png"
}
pages[#pages + 1] = {
    title = "Rescue",
