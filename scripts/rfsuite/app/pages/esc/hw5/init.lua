...
local function getEscModel(buffer) return getText(buffer, 49, 65) end

local function getEscVersion(buffer) return getText(buffer, 17, 32) end

local function getEscFirmware(buffer) return getText(buffer, 1, 16) end
