...
fields[#fields + 1] = {
    t = "Governor",
    vals = {mspHeaderBytes + 23},
    tableIdxInc = -1,
    table = govMode
}
fields[#fields + 1] = {
    t = "Gov-P",
    vals = {mspHeaderBytes + 37, mspHeaderBytes + 36}
}
fields[#fields + 1] = {
    t = "Gov-I",
    vals = {mspHeaderBytes + 39, mspHeaderBytes + 38}
}
fields[#fields + 1] = {
    t = "Gov-D",
    vals = {mspHeaderBytes + 41, mspHeaderBytes + 40}
}
fields[#fields + 1] = {
    t = "Motor ERPM max",
    vals = {mspHeaderBytes + 44, mspHeaderBytes + 43, mspHeaderBytes + 42}
}
