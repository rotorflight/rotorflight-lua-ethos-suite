local mspapi = {
    ...
    formdata = {
        ...
        fields = {
            ...
            {row = 4, col = 1, min = 0, max = 255, default = 250, decimals = 2, scale = 10, mspapi = 1, apikey = "rcRates_4"},
            ...
            {row = 4, col = 2, min = 0, max = 2008.2, default = 10, decimals = 1, mult = 4.807, step = 10, scale=100, mspapi = 1, apikey = "rates_4"}, -- this field is wonky
