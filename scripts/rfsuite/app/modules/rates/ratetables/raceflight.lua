local mspapi = {
    ...
    formdata = {
        ...
        fields = {
            {row = 1, col = 1, min = 0, max = 100, default = 36, mult = 10, mspapi = 1, apikey = "rcRates_1"},
            {row = 2, col = 1, min = 0, max = 100, default = 36, mult = 10, mspapi = 1, apikey = "rcRates_2"},
            {row = 3, col = 1, min = 0, max = 100, default = 36, mult = 10, mspapi = 1, apikey = "rcRates_3"},
