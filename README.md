...
**Status Widget**  
Dashboard themes are available for different flight states. See the [Dashboard Themes Overview](docs/dashboard-themes-overview.md) to compare the available theme previews.
