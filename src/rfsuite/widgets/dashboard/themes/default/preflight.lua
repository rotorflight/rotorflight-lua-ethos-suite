...
local function buildBoxes(W)
    ...
    return {
        {col = 1, row = 1, colspan = 8, rowspan = 4, type = "image", subtype = "model", bgcolor = colorMode.bgcolor}, {col = 1, row = 5, colspan = 4, rowspan = 2, type = "time", subtype = "flight", title = "TIME", titlepos = "bottom", titlecolor = colorMode.titlecolor, textcolor = colorMode.titlecolor, bgcolor = colorMode.bgcolor},
        {col = 5, row = 5, colspan = 4, rowspan = 2, type = "text", subtype = "blackbox", title = "BLACKBOX", titlepos = "bottom", decimals = 0, titlecolor = colorMode.titlecolor, textcolor = colorMode.titlecolor, bgcolor = colorMode.bgcolor},
