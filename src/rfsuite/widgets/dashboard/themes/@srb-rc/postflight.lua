...
local themeOptions = {
    ls_full = {font = "FONT_XXL", titlefont = "FONT_S", titlepaddingtop = 20},
    ls_std = {font = "FONT_XL", titlefont = "FONT_XS", titlepaddingtop = 10},
    ms_full = {font = "FONT_XL", titlefont = "FONT_XXS", titlepaddingtop = 10},
    ms_std = {font = "FONT_XL", titlefont = "FONT_XXS", titlepaddingtop = 5},
