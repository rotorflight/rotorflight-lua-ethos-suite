...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "boot_byte",                 type = "U8",  apiVersion = {12, 0, 9}, simResponse = {1}},
    {field = "layout_revision",           type = "U8",  apiVersion = {12, 0, 9}, simResponse = {2}},
    {field = "boot_loader_revision",      type = "U8",  apiVersion = {12, 0, 9}, simResponse = {13}},
    {field = "main_revision",             type = "U8",  apiVersion = {12, 0, 9}, simResponse = {2}},
    {field = "sub_revision",              type = "U8",  apiVersion = {12, 0, 9}, simResponse = {17}},
    {field = "name",                      type = "U96", apiVersion = {12, 0, 9}, simResponse = {86,105,109,100,114,111,110,101,76,52,51,49}}, -- string
    ...
    {field = "complementary_pwm",         type = "U8",  apiVersion = {12, 0, 9}, simResponse = {1}, tableIdxInc = -1, table = onOff},
    {field = "variable_pwm_frequency",    type = "U8",  apiVersion = {12, 0, 9}, simResponse = {1}, tableIdxInc = -1, table = onOff},
    {field = "stuck_rotor_protection",    type = "U8",  apiVersion = {12, 0, 9}, simResponse = {1}, tableIdxInc = -1, table = onOff},
    {field = "timing_advance",            type = "U8",  apiVersion = {12, 0, 9}, simResponse = {2}, tableIdxInc = -1, table = timingAdvance}, -- *7.5
    {field = "pwm_frequency",             type = "U8",  apiVersion = {12, 0, 9}, simResponse = {24}},
    {field = "startup_power",             type = "U8",  apiVersion = {12, 0, 9}, simResponse = {150}, default = 100, min = 50, max = 150},
    {field = "motor_kv",                  type = "U8",  apiVersion = {12, 0, 9}, simResponse = {107}, min = 20, max = 10220, scale = 40}, -- *40+20
    {field = "motor_poles",               type = "U8",  apiVersion = {12, 0, 9}, simResponse = {14}, default = 14, min = 2, max = 36},
    {field = "brake_on_stop",             type = "U8",  apiVersion = {12, 0, 9}, simResponse = {1}, tableIdxInc = -1, table = onOff},
    {field = "stall_protection",          type = "U8",  apiVersion = {12, 0, 9}, simResponse = {0}, tableIdxInc = -1, table = onOff},
    {field = "beep_volume",               type = "U8",  apiVersion = {12, 0, 9}, simResponse = {10}, default = 10, min = 0, max = 11},
    ...
    {field = "sine_mode_range",           type = "U8",  apiVersion = {12, 0, 9}, simResponse = {15}},
    ...
    {field = "sine_mode_power",           type = "U8",  apiVersion = {12, 0, 9}, simResponse = {6}},
