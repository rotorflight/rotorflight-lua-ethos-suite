...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    {field = "layout_revision",           type = "U8",  apiVersion = {12, 0, 9}, simResponse = {3}},
    {field = "boot_loader_revision",      type = "U8",  apiVersion = {12, 0, 9}, simResponse = {1}},
    {field = "main_revision",             type = "U8",  apiVersion = {12, 0, 9}, simResponse = {2}},
    {field = "sub_revision",              type = "U8",  apiVersion = {12, 0, 9}, simResponse = {19}},
    {field = "name",                      type = "U96", apiVersion = {12, 0, 9}, simResponse = {80,1,0,10,100,0,100,0,255,255,255,255}}, -- string
