...
local API_NAME = "ESC_PARAMETERS_HW5_COMPACT"
...
-- Compact layout: firmware_version and esc_type are stripped from the payload.
-- hardware_version is retained for model/profile identification.
-- Payload: [sig][ver][hardware_version×16][com_version×15][writable params×16] = 49 bytes
local FIELD_SPEC = {
    {"esc_signature", "U8"},
    {"esc_command", "U8"},
...
local SIM_RESPONSE = core.simResponse({
    253, -- esc_signature
    0,   -- esc_command
    72, 87, 49, 49, 48, 54, 95, 86, 49, 48, 48, 52, 53, 54, 78, 66, -- hardware_version ("HW1106_V100456NB")
    80, 108, 97, 116, 105, 110, 117, 109, 32, 86, 53, 32, 32, 32, 32, -- com_version ("Platinum V5    ")
    0,  -- flight_mode
    0,  -- lipo_cell_count
    0,  -- volt_cutoff_type
    3,  -- cutoff_voltage
