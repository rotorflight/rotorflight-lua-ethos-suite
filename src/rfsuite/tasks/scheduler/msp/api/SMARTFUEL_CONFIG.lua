...
local MSP_API_STRUCTURE_READ_DATA = {
    ...
    { field = "voltage_stabilize_delay",   type = "U16", default = 1500, min = 0, max = 10000, unit = "ms", simResponse = {220, 5} },
    { field = "voltage_stable_window",     type = "U16", default = 15,   min = 0, max = 100, decimals = 2, unit = "V", simResponse = {15, 0} },
