...
local core = (rfsuite.tasks and rfsuite.tasks.msp and rfsuite.tasks.msp.apiv2core) or assert(loadfile("SCRIPTS:/" .. rfsuite.config.baseDir .. "/tasks/scheduler/msp/apiv2/core.lua"))()
