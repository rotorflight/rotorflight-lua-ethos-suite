...
local T = {
    actionProbeOnly = "Probe only",
    actionRfToElrs = "RF -> ELRS",
    actionElrsToRf = "ELRS -> RF",
    idle = "Idle",
    writingElrs = "Writing ELRS module settings",
    elrsMatchesRf = "ELRS module already matches Rotorflight",
    elrsProbeComplete = "ELRS module probe complete",
    rfMatchesElrs = "Rotorflight already matches ELRS",
    writingRotorflight = "Writing Rotorflight telemetry settings",
    savingRotorflight = "Saving Rotorflight telemetry",
    rotorflightUpdated = "Rotorflight updated from ELRS",
    rotorflightSaveFailed = "Rotorflight sync failed while saving",
    rotorflightWriteFailed = "Rotorflight sync write failed",
    rotorflightWriteRejected = "Rotorflight sync write was rejected",
    probeComplete = "Probe complete",
    readingModule = "Reading ELRS module parameters",
    requiresActiveLink = "This tool requires an active CRSF link",
    waitingRotorflightConfig = "Waiting for Rotorflight telemetry config",
    rotorflightConfigNotReady = "Rotorflight telemetry config was not ready",
    pingingModule = "Pinging ELRS module",
    noModule = "No ELRS TX module responded",
    readTimeout = "ELRS module read timed out",
    sensorUnavailable = "CRSF sensor unavailable",
    writingPrefix = "Writing ",
    elrsUpdated = "ELRS module updated from Rotorflight",
    unavailableSimulation = "Unavailable in simulation",
    connectFirst = "Connect to a model first",
    requiresCrsf = "This tool requires CRSF telemetry",
    unavailableInFlight = "Unavailable while in flight",
    unavailableArmed = "Unavailable while armed",
