...
local function openPage(opts)
    ...
    line = addFieldLine(safetyPanel, "@i18n(app.modules.settings.txt_show_battery_type_connect)@")
    rfsuite.app.formFields[formFieldCount] = form.addBooleanField(line, nil, function()
        return prefBool(config.show_battery_type_startup, true)
    end, function(newValue) config.show_battery_type_startup = newValue end)
