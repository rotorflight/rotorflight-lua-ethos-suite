...
local apidata = {
    ...
    formdata = {labels = {}, fields = {{t = "Startup time", mspapi = 1, apikey = "gov_rpm_filter"}, {t = "Voltage Filter Cutoff", mspapi = 1, apikey = "gov_pwr_filter"}, {t = "TTA Bandwidth", mspapi = 1, apikey = "gov_tta_filter"}, {t = "Precomp Bandwidth", mspapi = 1, apikey = "gov_ff_filter"}, {t = "D-Term Cutoff", mspapi = 1, apikey = "gov_d_filter"}}}
}
