...
return {apidata = apidata, title = "MSP Experimental", navButtons = {menu = true, save = true, reload = true, help = true}, onNavMenu = onNavMenu, eepromWrite = true, postLoad = postLoad, wakeup = wakeup, preUnload = preUnload, API = {}}
