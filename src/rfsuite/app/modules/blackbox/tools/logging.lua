...
local pageTitle = "Blackbox / Logging"
...
local FIELD_DEFS = {
    ...
    {label = "VBUS", bit = 17},
    {label = "Temps", bit = 18},
    {label = "ESC", bit = 19, apiversiongte = {12, 0, 7}, featureBit = FEATURE_BITS.esc_sensor},
    {label = "BEC", bit = 20, apiversiongte = {12, 0, 7}, featureBit = FEATURE_BITS.esc_sensor},
    {label = "ESC2", bit = 21, apiversiongte = {12, 0, 7}, featureBit = FEATURE_BITS.esc_sensor},
    {label = "Governor", bit = 22, apiversiongte = {12, 0, 9}, featureBit = FEATURE_BITS.governor}
}
