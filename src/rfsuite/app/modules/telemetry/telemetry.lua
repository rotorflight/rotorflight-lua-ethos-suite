...
if not TELEMETRY_STATIC_CACHE then
    local sensorList = {
        [1] = {name = "@i18n(telemetry.sensor_1)@", group = "system"},
        [3] = {name = "@i18n(telemetry.sensor_3)@", group = "battery"},
        [4] = {name = "@i18n(telemetry.sensor_4)@", group = "battery"},
        [5] = {name = "@i18n(telemetry.sensor_5)@", group = "battery"},
        [6] = {name = "@i18n(telemetry.sensor_6)@", group = "battery"},
        [7] = {name = "@i18n(telemetry.sensor_7)@", group = "battery"},
        [8] = {name = "@i18n(telemetry.sensor_8)@", group = "battery"},
        [9] = {name = "@i18n(telemetry.sensor_9)@", group = "battery"},
        [10] = {name = "@i18n(telemetry.sensor_10)@", group = "control"},
        [11] = {name = "@i18n(telemetry.sensor_11)@", group = "control"},
        [12] = {name = "@i18n(telemetry.sensor_12)@", group = "control"},
        [13] = {name = "@i18n(telemetry.sensor_13)@", group = "control"},
        [14] = {name = "@i18n(telemetry.sensor_14)@", group = "control"},
        [15] = {name = "@i18n(telemetry.sensor_15)@", group = "control"},
        [17] = {name = "@i18n(telemetry.sensor_17)@", group = "esc1"},
        [18] = {name = "@i18n(telemetry.sensor_18)@", group = "esc1"},
        [19] = {name = "@i18n(telemetry.sensor_19)@", group = "esc1"},
        [20] = {name = "@i18n(telemetry.sensor_20)@", group = "esc1"},
        [21] = {name = "@i18n(telemetry.sensor_21)@", group = "esc1"},
        [22] = {name = "@i18n(telemetry.sensor_22)@", group = "esc1"},
        [23] = {name = "@i18n(telemetry.sensor_23)@", group = "esc1"},
        [24] = {name = "@i18n(telemetry.sensor_24)@", group = "esc1"},
        [25] = {name = "@i18n(telemetry.sensor_25)@", group = "esc1"},
        [26] = {name = "@i18n(telemetry.sensor_26)@", group = "esc1"},
        [27] = {name = "@i18n(telemetry.sensor_27)@", group = "esc1"},
        [28] = {name = "@i18n(telemetry.sensor_28)@", group = "esc1"},
        [30] = {name = "@i18n(telemetry.sensor_30)@", group = "esc2"},
        [31] = {name = "@i18n(telemetry.sensor_31)@", group = "esc2"},
        [32] = {name = "@i18n(telemetry.sensor_32)@", group = "esc2"},
        [33] = {name = "@i18n(telemetry.sensor_33)@", group = "esc2"},
        [36] = {name = "@i18n(telemetry.sensor_36)@", group = "esc2"},
        [41] = {name = "@i18n(telemetry.sensor_41)@", group = "esc2"},
        [42] = {name = "@i18n(telemetry.sensor_42)@", group = "voltage"},
        [43] = {name = "@i18n(telemetry.sensor_43)@", group = "voltage"},
        [44] = {name = "@i18n(telemetry.sensor_44)@", group = "voltage"},
        [45] = {name = "@i18n(telemetry.sensor_45)@", group = "voltage"},
        [46] = {name = "@i18n(telemetry.sensor_46)@", group = "current"},
        [47] = {name = "@i18n(telemetry.sensor_47)@", group = "current"},
        [48] = {name = "@i18n(telemetry.sensor_48)@", group = "current"},
        [49] = {name = "@i18n(telemetry.sensor_49)@", group = "current"},
        [50] = {name = "@i18n(telemetry.sensor_50)@", group = "temps"},
        [51] = {name = "@i18n(telemetry.sensor_51)@", group = "temps"},
        [52] = {name = "@i18n(telemetry.sensor_52)@", group = "temps"},
        [57] = {name = "@i18n(telemetry.sensor_57)@", group = "gyro"},
        [58] = {name = "@i18n(telemetry.sensor_58)@", group = "barometer"},
        [59] = {name = "@i18n(telemetry.sensor_59)@", group = "barometer"},
        [60] = {name = "@i18n(telemetry.sensor_60)@", group = "rpm"},
        [61] = {name = "@i18n(telemetry.sensor_61)@", group = "rpm"},
        [64] = {name = "@i18n(telemetry.sensor_64)@", group = "gyro"},
        [65] = {name = "@i18n(telemetry.sensor_65)@", group = "gyro"},
        [66] = {name = "@i18n(telemetry.sensor_66)@", group = "gyro"},
        [67] = {name = "@i18n(telemetry.sensor_67)@", group = "gyro"},
        [68] = {name = "@i18n(telemetry.sensor_68)@", group = "gyro"},
        [69] = {name = "@i18n(telemetry.sensor_69)@", group = "gyro"},
        [70] = {name = "@i18n(telemetry.sensor_70)@", group = "gyro"},
        [71] = {name = "@i18n(telemetry.sensor_71)@", group = "gyro"},
        [73] = {name = "@i18n(telemetry.sensor_73)@", group = "gps"},
        [74] = {name = "@i18n(telemetry.sensor_74)@", group = "gps"},
        [75] = {name = "@i18n(telemetry.sensor_75)@", group = "gps"},
        [76] = {name = "@i18n(telemetry.sensor_76)@", group = "gps"},
        [77] = {name = "@i18n(telemetry.sensor_77)@", group = "gps"},
        [78] = {name = "@i18n(telemetry.sensor_78)@", group = "gps"},
        [79] = {name = "@i18n(telemetry.sensor_79)@", group = "gps"},
        [80] = {name = "@i18n(telemetry.sensor_80)@", group = "gps"},
        [81] = {name = "@i18n(telemetry.sensor_81)@", group = "gps"},
        [82] = {name = "@i18n(telemetry.sensor_82)@", group = "gps"},
        [85] = {name = "@i18n(telemetry.sensor_85)@", group = "system"},
        [86] = {name = "@i18n(telemetry.sensor_86)@", group = "system"},
        [87] = {name = "@i18n(telemetry.sensor_87)@", group = "system"},
        [88] = {name = "@i18n(telemetry.sensor_88)@", group = "status"},
        [89] = {name = "@i18n(telemetry.sensor_89)@", group = "status"},
        [90] = {name = "@i18n(telemetry.sensor_90)@", group = "status"},
        [91] = {name = "@i18n(telemetry.sensor_91)@", group = "status"},
        [92] = {name = "@i18n(telemetry.sensor_92)@", group = "status"},
        [93] = {name = "@i18n(telemetry.sensor_93)@", group = "status"},
        [95] = {name = "@i18n(telemetry.sensor_95)@", group = "profiles"},
        [96] = {name = "@i18n(telemetry.sensor_96)@", group = "profiles"},
        [97] = {name = "@i18n(telemetry.sensor_97)@", group = "profiles"},
        [98] = {name = "@i18n(telemetry.sensor_98)@", group = "profiles"},
        [99] = {name = "@i18n(telemetry.sensor_99)@", group = "status"},
        [100] = {name = "@i18n(telemetry.sensor_100)@", group = "debug"},
        [101] = {name = "@i18n(telemetry.sensor_101)@", group = "debug"},
        [102] = {name = "@i18n(telemetry.sensor_102)@", group = "debug"},
        [103] = {name = "@i18n(telemetry.sensor_103)@", group = "debug"},
        [104] = {name = "@i18n(telemetry.sensor_104)@", group = "debug"},
        [105] = {name = "@i18n(telemetry.sensor_105)@", group = "debug"},
        [106] = {name = "@i18n(telemetry.sensor_106)@", group = "debug"},
        [107] = {name = "@i18n(telemetry.sensor_107)@", group = "debug"}
    }
