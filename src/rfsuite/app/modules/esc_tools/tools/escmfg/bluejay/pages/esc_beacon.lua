...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            {t = "Beep Strength", mspapi = 1, apikey = "beep_strength"},
            {t = "Beacon Strength", mspapi = 1, apikey = "beacon_strength"},
            {t = "Beacon Delay", type = 1, mspapi = 1, apikey = "beacon_delay"},
...
return {
    ...
    pageTitle = "Esc Programing" .. " / " .. ESC.toolName .. " / " .. "Beacon",
