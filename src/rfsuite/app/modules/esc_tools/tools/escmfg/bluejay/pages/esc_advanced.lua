...
local apidata = {
    ...
    formdata = {
        ...
        fields = {
            {t = "Motor Timing", type = 1, mspapi = 1, apikey = "commutation_timing"},
            {t = "Demag Compensation", type = 1, mspapi = 1, apikey = "demag_compensation"},
...
return {
    ...
    pageTitle = "Esc Programing" .. " / " .. ESC.toolName .. " / " .. "Brake",
