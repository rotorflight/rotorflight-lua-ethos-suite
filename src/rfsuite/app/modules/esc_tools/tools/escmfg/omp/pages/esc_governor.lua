...
return {apidata = apidata, eepromWrite = true, reboot = false, postLoad = postLoad, navButtons = navHandlers.navButtons, onNavMenu = navHandlers.onNavMenu, event = navHandlers.event, pageTitle = "Esc Programing" .. " / " .. "OMP" .. " / " .. "Governor", headerLine = rfsuite.escHeaderLineText, wakeup = wakeup}
